          ...
          >
            ...
            <div className="stat-card">
              ...
              <span
                ...
                style={{
                  color:
                    report.summary.netGainLossDiff === 0
                      ? "var(--green)"
                      : report.summary.netGainLossDiff > 0
                        ? "var(--red)"
                        : "var(--yellow, #eab308)",
                  ...
                  >
                    <span
                      style={{
                        ...
                        color:
                          STATUS_COLORS[item.status] || "var(--text-muted)",
                      }}
                    >
