...
export function TransactionTable({
  ...
  const allSelected =
    transactions.length > 0 && transactions.every((tx) => selected.has(tx.id));
  ...
  function startEdit(tx: Transaction) {
    ...
    setEditForm({
      ...
      valueUsd: String(
        isBuy ? tx.receivedValueUsd || "" : tx.sentValueUsd || "",
      ),
                  ...
                  <tr key={tx.id} style={{ background: "var(--bg-secondary)" }}>
                    ...
                    <td>
                      <input
                        ...
                        onChange={(e) =>
                          setEditForm({ ...editForm, valueUsd: e.target.value })
                        }
                        style={{ ...editInputStyle, width: "100px" }}
                      />
                    </td>
                    <td>
                      <input
                        ...
                        onChange={(e) =>
                          setEditForm({ ...editForm, feeUsd: e.target.value })
                        }
        ...
        >
          ...
          {getPageNumbers(meta.page, meta.totalPages).map((p, i) =>
            p === "..." ? (
              ...
              <button
                key={p}
                className={`btn ${meta.page === p ? "btn-primary" : "btn-secondary"}`}
