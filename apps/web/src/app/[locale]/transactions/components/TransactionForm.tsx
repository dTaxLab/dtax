  ...
  return (
    ...
    >
            ...
            <div style={{ display: "grid", gap: "10px" }}>
              <div>
                ...
                <input
                  ...
                  value={form.sentAsset}
                  onChange={(e) =>
                    setForm({
                      ...form,
                      sentAsset: e.target.value.toUpperCase(),
                    })
                  }
                  required
                  style={inputStyle}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, sentAmount: e.target.value })
                  }
                  required
                  style={inputStyle}
                />
              ...
              <div>
                ...
                <input
                  ...
                  step="any"
                  placeholder="0.00"
                  value={form.sentValueUsd}
                  onChange={(e) =>
                    setForm({ ...form, sentValueUsd: e.target.value })
                  }
                  required
                  style={inputStyle}
                />
            ...
            <div style={{ display: "grid", gap: "10px" }}>
              {isNft ? (
                <>
                  <div>
                    ...
                    <input
                      placeholder={t("form.nftCollectionPlaceholder")}
                      value={form.nftCollection}
                      onChange={(e) =>
                        setForm({
                          ...form,
                          nftCollection: e.target.value.toUpperCase(),
                        })
                      }
                      required
                      style={inputStyle}
                  ...
                  <div>
                    ...
                    <input
                      placeholder={t("form.nftTokenIdPlaceholder")}
                      value={form.nftTokenId}
                      onChange={(e) =>
                        setForm({ ...form, nftTokenId: e.target.value })
                      }
                      required
                      style={inputStyle}
                    />
                ...
                <div>
                  ...
                  <input
                    placeholder={t("form.assetPlaceholder")}
                    value={form.receivedAsset}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        receivedAsset: e.target.value.toUpperCase(),
                      })
                    }
                    required
                    style={inputStyle}
              ...
              <div>
                ...
                <input
                  ...
                  step="any"
                  placeholder="0.00"
                  value={form.receivedValueUsd}
                  onChange={(e) =>
                    setForm({ ...form, receivedValueUsd: e.target.value })
                  }
                  required
                  style={inputStyle}
                />
      ...
      {isNft && form.nftCollection && (
        ...
        >
          Asset ID:{" "}
          <code style={{ color: "var(--accent)" }}>{getNftAsset()}</code>
        </div>
      )}
