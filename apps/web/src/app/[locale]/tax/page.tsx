...
export default function TaxPage() {
  ...
  const [washSaleSummary, setWashSaleSummary] = useState<{
  ...
  return (
    <div className="animate-in">
      ...
      <div className="card" style={{ marginBottom: "24px" }}>
        ...
        {error && (
          <p
            style={{ color: "var(--red)", marginTop: "12px", fontSize: "14px" }}
          >
            ⚠️ {error}
          </p>
        )}
          ...
          {form8949 &&
            ...
            (() => {
              ...
              const assets = [...assetMap.entries()].sort(
                (a, b) => Math.abs(b[1].gainLoss) - Math.abs(a[1].gainLoss),
              );
              return (
                      ...
                      <thead>
                        <tr>
                          ...
                          <th style={{ textAlign: "right" }}>
                            {t("perAsset.dispositions")}
                          </th>
                          <th style={{ textAlign: "right" }}>
                            {t("perAsset.proceeds")}
                          </th>
                          <th style={{ textAlign: "right" }}>
                            {t("perAsset.costBasis")}
                          </th>
                          <th style={{ textAlign: "right" }}>
                            {t("perAsset.gainLoss")}
                          </th>
            ...
            >
              ...
              <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
                <div>
                  ...
                  >
                    {t("washSale.detected", {
                      count: washSaleSummary.adjustmentCount,
                    })}
                  </span>
                </div>
                <div>
                  ...
                  <tbody>
                    {scheduleD.partI.map((line) => (
                      <tr key={line.lineNumber}>
                        <td style={{ fontWeight: 600, width: "60px" }}>
                          {line.lineNumber}
                        </td>
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      fontSize: "16px",
                      color:
                        scheduleD.combinedNetGainLoss >= 0
                          ? "var(--green)"
                          : "var(--red)",
                    }}
                  >
                  ...
                  {form8949.boxSummaries.map((bs) => (
                    ...
                    >
                      <div style={{ fontWeight: 600, marginBottom: "4px" }}>
                        {t("form8949.box")} {bs.box} ({bs.lineCount}{" "}
                        {bs.lineCount === 1 ? "item" : "items"})
                      </div>
                      <div
                        style={{
                          color:
