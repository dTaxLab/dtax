  ...
  it("should match mixed TRANSFER and BRIDGE types", () => {
    const transfers: TransferRecord[] = [
      ...
      },
      {
        ...
        asset: "BTC",
        amount: 1,
        timestamp: new Date("2025-03-01T08:05:00Z"),
      },
      {
        id: "bridge-out",
        sourceId: "ethereum",
      ...
      },
      {
        ...
        asset: "USDC",
        amount: 500,
        timestamp: new Date("2025-03-01T09:20:00Z"),
      },
    ];
