...
describe('DeFi LP Tax Calculations', () => {
    ...
    describe('Full LP lifecycle', () => {
        it('should correctly track basis through deposit → withdraw → sell', () => {
            ...
            const remainingEth = calc.getLots().filter(l => l.asset === 'ETH' && l.amount > 0);
    ...
    describe('Form 8949 generation with LP transactions', () => {
        it('should include LP deposit and withdrawal in Form 8949', () => {
            ...
            calc.addLots([
                { id: 'eth-lot', asset: 'ETH', amount: 5, costBasisUsd: 10000, acquiredAt: new Date('2024-03-01'), sourceId: 'w1' },
                { id: 'lp-lot', asset: 'LP-ETH', amount: 10, costBasisUsd: 15000, acquiredAt: new Date('2025-01-15'), sourceId: 'w1' },
            ]);

            const events: TaxableEvent[] = [
                { id: 'dep', asset: 'ETH', amount: 5, proceedsUsd: 15000, date: new Date('2025-03-01'), sourceId: 'w1', feeUsd: 5 },
                { id: 'wit', asset: 'LP-ETH', amount: 10, proceedsUsd: 18000, date: new Date('2025-06-01'), sourceId: 'w1', feeUsd: 8 },
            ];
